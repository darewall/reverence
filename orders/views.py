...
def order_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            order = Order(
                ...
                last_name=form.cleaned_data.get('flast_name'),
                middle_name=form.cleaned_data.get('middle_name'),
                city=form.cleaned_data.get('city'),
                street=form.cleaned_data.get('street'),
                house_number=form.cleaned_data.get('house_number'),
                apartament_number=form.cleaned_data.get('apartament_number'),
            ...
            try:
                ...
                return render(request, 'orders/order_form.html', {'cart': cart, 'error': str(e), 'form':form})
    ...
    form = OrderForm(initial={
        ...
        'apartament_number': request.user.apartament_number,
